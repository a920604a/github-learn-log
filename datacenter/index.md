...
| 下一張 | `dc-19` 一次側／二次側冰水泵（[W36 週報](weekly/2026-W36.md)：動筆前先做完卡片修正機制 ＋ `energy_kwh()` 改名，合計 40 分鐘）。[dc-18](devices/chiller.md) 的 ride-through 計算整段建立在「泵在 UPS 上」這個假設上——20 m³ 環路撐 5.2 分鐘的前提是水還在流。明天正好查證這件事的代價與做法 |
