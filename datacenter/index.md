...
| 下一張 | `dc-21` 板式熱交換器與免費冷卻。[dc-20](devices/thermal-storage-tank.md) 答的是「冰機停了怎麼撐」，dc-21 答的是「冰機可以少開多久」——同一條熱鏈的另一種容量來源。（`dc-19b` NPSH 仍在佇列上方待寫，但它自己註明優先度低於 dc-20）|
