...
| 下一張 | `dc-22` CRAH 機房空調（冰水式）。[dc-21](devices/plate-hx-free-cooling.md) 演算三留下的「換熱器過關、末端盤管不過關」（WB 45 °F 時顯熱出力 <25%、潛熱 0%）正是 CRAH 的 LMTD 問題；而 dc-21 那張門檻濕球表的自變數 `T_chws` 從哪來，答案也在 CRAH 的盤管選型裡 |
