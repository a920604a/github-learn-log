...
| 下一張 | `dc-20` 儲冷槽（thermal storage tank）與 ride-through。[dc-18](devices/chiller.md) 算過：20 m³ 環路只撐 5.2 分鐘，要撐 15 分鐘需 57 m³——而 [dc-19](devices/chilled-water-pump.md) 剛確認那 5.2 分鐘的前提（泵在 UPS 上）要付 +5.6% UPS 負載、runtime −5% 的代價 |
