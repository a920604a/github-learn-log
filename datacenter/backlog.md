...
- [ ] `dc-19b` NPSH 與泵的擺放高度（吸入條件、汽蝕、冷卻水泵為什麼在地面層）— 從 dc-19 拆出，優先度低於 dc-20
...
- 已完成：28（2026-09-08 dc-20；2026-09-07 dc-19；2026-09-04 dc-18；2026-09-03 dc-17 **第二輪冷卻鏈開工**；第一輪電力鏈 dc-01 ~ dc-16 已於 2026-09-02 全數完成）
