...
> 本卡只談**容量與額定語意**；短路耐受（`Icw` / `Ipk`）、保護協調、ZSI 與 arc flash 分到 `dc-07b`。
...
- **美規對照**：UL 1558（switchgear，電力斷路器、抽出式、有隔艙，最大 6000 A）vs UL 891（switchboard，模殼斷路器、多為固定式、密度高，最大 5000 A）。**短路耐受差異留給 `dc-07b`。**
